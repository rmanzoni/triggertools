...
data_file = ROOT.TFile.Open('../test/diTau_plots_ICHEP.root','read')
data_file.cd()
data_graph = data_file.Get('lowmt_zmass_sub_MediumIso_HLT/tau_pt')
...
dge.GetXaxis().SetRangeUser(0., 300.)
