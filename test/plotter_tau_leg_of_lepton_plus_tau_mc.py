...
weight = {
    '' : ' weight_vertex * weight_gen / abs(weight_gen) * l1_weight_trigger * l1_weight_idiso * l1_weight_tracking ',
}
...
filenames = [
    '../../summer2016/DYJetsToLL_M50_LO_ext/H2TauTauTreeProducerTauMu/skim.root',
    '../../summer2016/WJetsToLNu_LO/H2TauTauTreeProducerTauMu/skim.root',
]
