...
period = {
    ''       : ' 1 ',
#     'before276215'       : ' run < 276215 '               , # HLT_Ele24_eta2p1_WPLoose_Gsf_LooseIsoPFTau20_SingleL1_v
#     'from276215to278270' : ' run >=276215 & run < 278270 ', # HLT_Ele24_eta2p1_WPLoose_Gsf_LooseIsoPFTau20_v
#     'after278270'        : ' run >= 278270 '              , # HLT_Ele24_eta2p1_WPLoose_Gsf_LooseIsoPFTau30_v
#     'ichep'  : ' period < 4 ',
#     'prehip' : ' period < 6 ',
#     'posthip': ' period >= 6 ',
}
...
HLT_LooseIso30_L1iso26   = ' l2_L1_type == 7 & l2_L1_bx == 0 & l2_L1_iso == 1 & l2_L1_pt >= 26. & (trigger_matched_isomu19looseisotau20          || trigger_matched_isomu21looseisotau20         ) & l2_trig_obj_pt > 30 '

TriggerSelection = {
    'HLT_LooseIso20_SingleL1'  : HLT_LooseIso20_SingleL1 ,
#     'HLT_LooseIso20_L1noiso20' : HLT_LooseIso20_L1noiso20,
#     'HLT_LooseIso30_L1iso26'   : HLT_LooseIso30_L1iso26  ,
    'HLT_tau_leg_et_combined'  : ' (run < 276215) * (%s) + (run >=276215 & run < 278270) * (%s) + (run >= 278270) * (%s) ' %(HLT_LooseIso20_SingleL1, HLT_LooseIso20_L1noiso20, HLT_LooseIso30_L1iso26),
}
...
HLTPlotter = Plotter(variables     = variables                         , 
                     out_filename  = 'tauleg_of_lepton_plus_tau_real_taus_skim_v2.root'     , 
